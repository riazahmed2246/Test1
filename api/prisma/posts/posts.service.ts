...
const MessagesService = require('../marketplace/messages.service');
const StripeService = require('../../services/stripe.service');
const IntegrationService = require('../integrations/integration.service');
const MediaService = require('../media/media.service');
const ShortLinkService = require('../../short-linking/short.link.service');
const WebhooksService = require('../webhooks/webhooks.service');
const { makeId } = require('../../services/make.is');
const dayjs = require('dayjs');
const { capitalize, shuffle, uniq } = require('lodash');
const axios = require('axios');
const sharp = require('sharp');
const { Readable } = require('stream');
const { timer } = require('@gitroom/helpers/utils/timer');
...
class PostsService {
  ...
  private async updateTags(orgId, post) {
