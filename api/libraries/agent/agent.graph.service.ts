...
import { GeneratorDto } from '../dtos/generator/generator.dto';
...
export class AgentGraphService {
  ...
  static state() {
    return new StateGraph<WorkflowChannelsState>({
      channels: {
        messages: {
        ...
        popularPosts: null as any,
        topic: null as any,
        isPicture: null as any,
      },
    });
  }
