import { ThirdParty, ThirdPartyAbstract, ThirdPartyParams } from '../thirdparty.interface';
import { OpenaiService } from '../../openai/openai.service';
import { timer } from '../../../../helpers/utils/timer';

export class HeygenProvider extends ThirdPartyAbstract<any> {
  // Use a property to hold the HeyGen parameters instead of a decorator
  public readonly params: ThirdPartyParams = {
    identifier: 'heygen',
    title: 'HeyGen',
